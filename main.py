...
def main(args):
    ...
    dataset_train = build_dataset(image_set=image_set, args=args)#二次训练的数据
    dataset_val = build_dataset(image_set='val', args=args)#最后的评估阶段的数据
    dataset_support = build_support_dataset(image_set=image_set, args=args)#第一次训练的数据 只基于image_set
